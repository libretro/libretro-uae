...
bool ncr_alf3_autoconfig_init(struct autoconfig_info *aci) { return false; }
bool ncr_dkb_autoconfig_init(struct autoconfig_info *aci) { return false; }
bool ncr_ematrix_autoconfig_init(struct autoconfig_info *aci) { return false; }
bool ncr_fastlane_autoconfig_init(struct autoconfig_info *aci) { return false; }
bool ncr_multievolution_init(struct autoconfig_info *aci) { return false; }
bool ncr_mtecmastercard_init(struct autoconfig_info *aci) { return false; }
bool ncr_oktagon_autoconfig_init(struct autoconfig_info *aci) { return false; }
bool ncr_rapidfire_init(struct autoconfig_info *aci) { return false; }
bool ncr_scram5394_init(struct autoconfig_info *aci) { return false; }
bool typhoon2scsi_init(struct autoconfig_info *aci) { return false; }
...
uae_u32 golemfast_ncr9x_scsi_get(uaecptr addr, int devnum) { return 0; }
void golemfast_ncr9x_scsi_put(uaecptr addr, uae_u32 v, int devnum) {}

uae_u32 masoboshi_ncr9x_scsi_get(uaecptr addr, int devnum) { return 0; }
void masoboshi_ncr9x_scsi_put(uaecptr addr, uae_u32 v, int devnum) {}

uae_u32 squirrel_ncr9x_scsi_get(uaecptr addr, int devnum) {	return 0; }
void squirrel_ncr9x_scsi_put(uaecptr addr, uae_u32 v, int devnum) {}

uae_u32 trifecta_ncr9x_scsi_get(uaecptr addr, int devnum) { return 0; }
void trifecta_ncr9x_scsi_put(uaecptr addr, uae_u32 v, int devnum) {}
