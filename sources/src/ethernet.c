...
bool ethernet_enumerate (struct netdriverdata **td, int romtype) { return false; }
void ethernet_enumerate_free (void) {}
int ethernet_open (struct netdriverdata *ndd, void *vsd, void *user, ethernet_gotfunc *gotfunc, ethernet_getfunc *getfunc, int promiscuous, const uae_u8 *mac) { return 0; }
void ethernet_close (struct netdriverdata *ndd, void *vsd) {}
int ethernet_getdatalenght (struct netdriverdata *ndd) { return 0; }
void ethernet_trigger (struct netdriverdata *ndd, void *vsd) {}

struct autoconfig_info;
bool hydra_init(struct autoconfig_info *aci) { return false; }
bool lanrover_init(struct autoconfig_info *aci) { return false; }
bool xsurf_init(struct autoconfig_info *aci) { return false; }
bool xsurf100_init(struct autoconfig_info *aci) { return false; }
