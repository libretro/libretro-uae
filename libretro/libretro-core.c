...
{
   int visible_left_border_new = retro_max_diwlastword - retrow + ((retrow - zoomed_width) / 2) + 2;
   ...
   else if (retro_min_diwstart == 30000 && retro_max_diwstop == 0 && visible_left_border != 0)
