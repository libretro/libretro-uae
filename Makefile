...
# Set to 0 to use pthreads instead of libco to run the emulator main loop.
USE_LIBCO := 1
...
DEFINES += -DCPUEMU_0 -DCPUEMU_11 -DCPUEMU_12 -DCPUEMU_20 -DCPUEMU_21 -DCPUEMU_22 -DCPUEMU_31 -DCPUEMU_32 -DCPUEMU_33 -DMMUEMU -DFULLMMU -DFPUEMU -DUNALIGNED_PROFITABLE -DAMAX -DAGA -DAUTOCONFIG -DFILESYS -DSUPPORT_THREADS -DFDI2RAW -DDEBUGGER -DSAVESTATE -DACTION_REPLAY -DDRIVESOUND -DGAYLE -DNCR -DCD32 -DCDTV -DA2091
