...
#define SET_ZFLG(flags, y) ((flags)->cznv = ((flags)->cznv & ~0x4000) | (((y) & 1) << 14))
#define SET_CFLG(flags, y) ((flags)->cznv = ((flags)->cznv & ~0x100) | (((y) & 1) << 8))
#define SET_VFLG(flags, y) ((flags)->cznv = ((flags)->cznv & ~0x1) | (((y) & 1)))
#define SET_NFLG(flags, y) ((flags)->cznv = ((flags)->cznv & ~0x8000) | (((y) & 1) << 15))
#define SET_XFLG(flags, y) ((flags)->cznv = (y))

#define GET_ZFLG(flags) (((flags)->cznv >> 14) & 1)
#define GET_CFLG(flags) (((flags)->cznv >> 8) & 1)
#define GET_VFLG(flags) (((flags)->cznv >> 0) & 1)
#define GET_NFLG(flags) (((flags)->cznv >> 15) & 1)
#define GET_XFLG(flags) ((flags)->cznv & 1)
...
#define COPY_CARRY(flags) ((flags)->x = ((flags)->cznv)>>8)
